          ...
          <div className=" flex justify-between items-center p-2">
            ...
            <ul className=" flex justify-start items-center gap-2 p-2">
              <li >
                <DropdownMenu modal={false}>
                  <DropdownMenuTrigger asChild>
                    <p className=" cursor-pointer py-2 px-5 text-white rounded-md bg-sky-800 hover:bg-sky-600 transition-all duration-300 ease-in">
                      Register Now
                    </p>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent className="w-56">
              ...
              <li className=" cursor-pointer py-2 px-5 text-white rounded-md bg-sky-800 hover:bg-sky-600 transition-all duration-300 ease-in">
